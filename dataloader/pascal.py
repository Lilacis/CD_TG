...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot):
        ...
        self.img_path = os.path.join('/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/sff/VOCdevkit/VOC2012/JPEGImages/')
        self.ann_path = os.path.join('/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/sff/VOCdevkit/VOC2012/SegmentationClassAug/')
